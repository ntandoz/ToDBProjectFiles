...
.showDiv{
 ...
 <script type="text/javascript">
		...
		document.getElementById("researchDetailsPage").className="hideDiv";
                document.getElementById("miscellaneousPage").className="hideDiv";
		...
		//var This is for the overal validation of the form
                 if( document.getElementById("detailsPage").className=="showDiv")
                  ...
                  if( document.getElementById("miscellaneousPage").className=="showDiv")
                    {
                          validateMiscellaneousPage();
                     }       
	    }
				...
				alert("Please Enter a source or Research Funding");  
			 	...
			 	return;
                       ...
                       else
                          {
                             ...
                             document.getElementById("externalAuthorsPage").className="hideDiv";
                             document.getElementById("researchDetailsPage").className="hideDiv";
                             document.getElementById("miscellaneousPage").className="showDiv";
                          }
             }

            function validateMiscellaneousPage()
             {
                     //Checking for the availability of values
...
<input type="hidden" name="todbDoctype" id="todbDoctype" value="MIS"/>
...
<!-- ***************************     Details Page Table Menu ****************************** -->
          ...
          <table>
			...
			<td><input type="button" value="Miscellaneous" id="ButtonAdd3" onclick="showDivFunction('miscellaneousPage')"/></td>
...
<!-- ***************************     Miscellaneous Tab    ****************************** -->
<table id="miscellaneousPage" class="hideDiv">
     <tr>
        <td>
		<p>&nbsp;</p>
       		...
       		<table>
             	<tr>
            		<td colspan="2" valign="top">
						Publication Type<br>
                		 <select name="todbPublicationType" id="todbPublicationType" style="width:150px; height: 26px;" value="${ssDefinitionEntry.customAttributes['todbPublicationType'].value}">
                               <option></option>
                                 <%                    
					try{
						for (PublicationType pt : pType)
						 {
                                                       if(pt.getWfd0026TodbDocumentType().getDocumentTypeCode().equalsIgnoreCase("MIS"))
                                                        {
                                   %>
...
<input type="text" name="todbOtherPublicationType" id="todbOtherPublicationType" value="${ssDefinitionEntry.customAttributes['todbOtherPublicationType'].value}" style="width:360px;"/> 
					...
					<td colspan="2" valign="top">
            			Security Classification<br>
                                 <select name="todbSecurityClassification" id="todbSecurityClassification" style="width:150px; height: 26px;"value="${ssDefinitionEntry.customAttributes['todbSecurityClassification'].value}">
				...
				<tr>
					...
					<td>
       					Client Name<br>
                 	<input type="text" name="todbClientName" id="todbClientName" value="${ssDefinitionEntry.customAttributes['todbClientName'].value}" size="50" /> 
					</td>
				...
				<tr>
					<td>
						Keywords<br>
			<textarea name="todbKeywords" id="todbKeywords" value="${ssDefinitionEntry.customAttributes['todbKeywords'].value}">
                        </textarea>
                    </td>
					<td>
                        Abstract<br>
                        <textarea name="todbAbstract" id="todbAbstract" value="${ssDefinitionEntry.customAttributes['todbAbstract'].value}">
                        </textarea>
                    </td>
					<td>
                        Notes<br>
			<textarea name="todbNotes" id="todbNotes" value="${ssDefinitionEntry.customAttributes['todbNotes'].value}">
			</textarea>
                    			</td>
				</tr>
			</table>
...
<!-- ***************************     External Authors List    ****************************** -->
     ...
     <table border="0">
             ...
             <tr>
                 ...
                 <td><input type="text" name="todbBU1"/></td></tr>
             <tr>
