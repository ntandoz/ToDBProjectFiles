...
.showDiv{
 ...
 <script type="text/javascript">
		...
		document.getElementById("researchDetailsPage").className="hideDiv";
                document.getElementById("thesisPage").className="hideDiv";
		...
		//var This is for the overal validation of the form
                 if( document.getElementById("detailsPage").className=="showDiv")
                  ...
                  if( document.getElementById("thesisPage").className=="showDiv")
                    {
                          validateThesis();
                     }
	    }
			...
			{  
				alert("Business Unit can't be blank");  
                                document.getElementById("todbBusinessUnits").focus(); 
			 	 return;
			 }  
			...
			{  
			       alert("Please Enter a source for Research Funding");  
			 	 ...
			 	 return;
                       ...
                       else
                          {
                             ...
                             document.getElementById("externalAuthorsPage").className="hideDiv";
                             document.getElementById("researchDetailsPage").className="hideDiv";
                             document.getElementById("thesisPage").className="showDiv";
...
<%	
	...
	//Employee Details
		...
		System.out.println("Read Employee Details: "+empDetailsList.size());
	//This code is for business Units
		...
		System.out.println("Read BU List: "+buList.size());
...
<input type="hidden" name="todbDoctype" id="todbDoctype" value="THE"/>
...
<tr><td>
          ...
          <table>
			...
			<td><input type="button" value="Thesis/Dissertation" id="ButtonAdd3" onclick="showDivFunction('thesisPage')"/></td>
			<td><input type="button" value="External Authors" onclick="showDivFunction('externalAuthorsPage')"/></td>  
                </tr>
          </table>  
</td></tr>
</table>
            ...
            <tr>
       		...
       		<table>
				...
				<input type="text" name="todbStaffNumber" id="todbStaffNumber" style="width:150px;" value=<%=empDetailsList.get(0).getEmpNo()%>>
                        				...
                        				<td>Name</td>
                        	<td><input type="text" name="todbUsername" id="todbUsername" style="width:150px;" value="<%=empDetailsList.get(0).getName()+" "+empDetailsList.get(0).getSurname()%>">
							</td>
                        				<td></td>
                        				<td></td>
                    				</tr>
                   		...
                   		<input type="text" name="todbBusinessUnit" id="todbBusinessUnit" style="width:150px;" value="<%=buList.get(0).getBuDesc()%>"> 
                               ...
                               <input type="text" name="todbDepartment" id="todbDepartment" value="<%=empDetailsList.get(0).getEntityOe2()%>" style="width:160px;">
                        				...
                        				<td>Competence Area</td>
                                                        <td><select name="todbCompetencyArea" id="todbCompetencyArea" value="${ssDefinitionEntry.customAttributes['todbCompetencyArea'].value}" style="width:160px;">
                                                    <option></option>
                          <%                    
								try{
...
<!-- ***************************     Thesis Tab    ****************************** -->
<table id="thesisPage" class="hideDiv">
         <tr><td>
		...
		<p>&nbsp;</p>
       		...
       		<table>
             	<tr>
            		<td colspan="2" valign="top">
						Publication Type<br>
                		 <select name="todbPublicationType" id="todbPublicationType"style="width:160px; height: 26px;">
                                     
                                     <%                    
					try{
						for (PublicationType pt : pType)
						 {
                                                     if(pt.getWfd0026TodbDocumentType().getDocumentTypeCode().equalsIgnoreCase("THE"))
                                                    {
                                %>
		...
		<input type="text" name="todbOtherPublicationType" id="todbOtherPublicationType" value="" style="width:360px;"/>
					</td>
					<td colspan="2" valign="top">
            			Security Classification<br>
                <select name="todbSecurityClassification" id="todbSecurityClassification" value="${ssDefinitionEntry.customAttributes['todbSecurityClassification'].value}"style="width:160px">
                                          <%                    
				...
				<tr>
					<td>    
            			Month<br> 
            			<select name="todbMonth" id="todbMonth" style="width: 88px;">
                    		<option></option>
					...
					<td>
                		Year<br>
            			<select name="todbYear" id="todbYear" style="width: 88px;">
                    		<option></option>
                                 <%
					...
					<td>
						...
						<input type="text" name="todbAcademicInstitution" id="todbAcademicInstitution" value="" style="width: 200px;"/>
					</td>
					<td>
                		Dissertation<br>
						<input type="text" name="todbDissertation" id="todbDissertation"  value="" style="width: 200px;"/>
					</td>
				</tr>
				<tr>
					<td>
			Keywords<br>
			<textarea name="todbKeywords" id="todbKeywords" rows="2" cols="20" style="width: 150px;resize:none;">
                        </textarea>
                    </td>
					<td>
                        Abstract<br>
                        <textarea name="todbAbstract" id="todbAbstract" rows="2" cols="20" style="width: 150px;resize:none;">
                        </textarea>
                    </td>
					<td>
                        Notes<br>
			<textarea name="todbNotes" id="todbNotes" rows="2" cols="20" style="width: 150px;resize:none;">
			</textarea>
                    </td>
				</tr>
			</table>
...
<!-- ***************************     External Authors List    ****************************** -->
     ...
     <table border="0">
             ...
             <tr>
                 <td><input type="text" name="todbAuthors1" id="todbAuthors1"/></td>
                
                 <td><input type="text" name="todbBU1" id="todbBU1"/></td></tr>
             <tr>
                 <td><input type="text" name="todbAuthors2" id="todbAuthors2"/></td>
                
                 <td><input type="text" name="todbBU2" id="todbBU2"/></td>                  
             </tr><tr>
                 <td><input type="text" name="todbAuthors3" id="todbAuthors3"/></td>
                
                 <td><input type="text" name="todbBU3" id="todbBU3"/></td>
                  
             </tr><tr>
                 <td><input type="text" name="todbAuthors4" id="todbAuthors4"/></td>
                
                 <td><input type="text" name="todbBU4" id="todbBU4"/></td>
                  
             </tr><tr>
                 <td><input type="text" name="todbAuthors5" id="todbAuthors5"/></td>
                
                 <td><input type="text" name="todbBU5" id="todbBU5"/></td>
                  
             </tr><tr>
                 <td><input type="text" name="todbAuthors6" id="todbAuthors6"/></td>
                
                 <td><input type="text" name="todbBU6" id="todbBU6"/></td>
...
<table id="researchDetailsPage" class="hideDiv">
      <tr>
		...
		<select name="todbResearchFunding" id="todbResearchFunding"  style="width:150px; height: 26px" value="${ssDefinitionEntry.customAttributes['todbResearchFunding'].value}">
                                 <option></option>
