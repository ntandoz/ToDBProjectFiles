...
.showDiv{
 ...
 <script type="text/javascript">
            ...
            document.getElementById("legalDocumentsPage").className="hideDiv";
	...
	
			{
                           ...
                           //document.getElementById("researchDetailsPage").removeAttribute("disabled");
                            

                             //Send the value to the function to change the tab
                             //alert(document.getElementById("researchDetailsPage").value);
			...
			{  
			 	 ...
			 	 return;
                       ...
                       else
                          {
                             ...
                             document.getElementById("externalAuthorsPage").className="hideDiv";
                             document.getElementById("researchDetailsPage").className="hideDiv";
                             document.getElementById("legalDocumentsPage").className="showDiv";
...
//Validate Legal documents
		...
		//var This is for the overal validation of the form
                 if( document.getElementById("detailsPage").className=="showDiv")
                  ...
                  if( document.getElementById("legalDocumentsPage").className=="showDiv")
                    {
                          validatelegalDocumentsPage();
                         
                        
                     }            
	    }

            function validatelegalDocumentsPage()
             {
                     //Checking for the availability of values
			...
			{  
				alert("Please select the Publication Type");  
			 	 ...
			 	 return;
                     ...
                     //Checking for Security Classification
                        if(document.getElementById("todbCompetencyArea").value==null || document.getElementById("todbCompetencyArea").value=="")
			{  
				alert("Please select the Security Classification");  
                               document.getElementById("todbCompetencyArea").focus();
...
<input type="hidden" name="todbDoctype" id="todbDoctype" value="LEG"/>
...
<tr><td>
        ...
        <!--div for the table for table alignment -->
       
          <table>
                <tr>
                     	<td><input type="button" value="General Details" onclick="showDivFunction('detailsPage')"/></td>
			<td><input type="button" value="Research Details" onclick="showDivFunction('researchDetailsPage')"/></td>
			<td><input type="button" value="Legal Documents"  onclick="showDivFunction('legalDocumentsPage')"/></td>
...
<!-- ***************************     Legal Documents Tab    ****************************** -->
 ...
 <table id="legalDocumentsPage" class="hideDiv">
         <tr><td>
			   ...
			   <option></option>
                         ...
                         <%                    
								try{
									 ...
									 {
                                                                             if(pt.getWfd0026TodbDocumentType().getDocumentTypeCode().equalsIgnoreCase("LEG"))
                                                                            {
                        %>
						...
						<input type="text" name="OtherPublicationType" value="" style="width:360px;"/> 
					</td>
					<td colspan="2" valign="top">
            			Security Classification<br>
                               <select style="width:150px" name="todbSecurityClassification" 
                           value="${ssDefinitionEntry.customAttributes['todbSecurityClassification'].value}" id="todbSecurityClassification">
			   <option></option>
				...
				<tr>
					<td>    
            			Date Signed<br>
                		<input type="date" name="dateSigned" value="" /> 
					</td>
					<td>
                		Duration<br>
						<input type="text" name="todbDuration" id="todbDuration" value="" style="width:55px;" />
					</td>
					<td>
       					Project Proposal<br>
						<input type="text" name="todbProjectProposal" id="todbProjectProposal"value="" style="width:55px;" />
					</td>
					<td>
       					Client Reference Number<br>
						<input type="text" name="todbClientReference" id="todbClientReference" value="" style="width:55px;" />
					</td>
...
<!-- ***************************     External Authors List    ****************************** -->
     ...
     <table border="0">
             ...
             <tr>
                 <td><input type="text" name="Authors" id="Eauthors"  /></td>
                
                 <td><input type="text" name="BU" id="Eauthors" /></td>
                  
             </tr>
             <tr>
                 <td><input type="text" name="Auuthors" id="Eauthors"  /></td>
